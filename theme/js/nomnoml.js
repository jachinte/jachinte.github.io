...
nomnoml.render = function (graphics, config, compartment, setFont){
	...
	var styles = {
		ABSTRACT: { center: X, bold: 0, underline: 0, italic: X, dashed: 0, borderless: 0, empty: 0, visual: 'class' },
		ACTOR:    { center: X, bold: 0, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: 0, visual: 'actor' },
		CHOICE:   { center: X, bold: 0, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: 0, visual: 'rhomb' },
		CLASS:    { center: X, bold: X, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: 0, visual: 'class' },
		DATABASE: { center: X, bold: X, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: 0, visual: 'database' },
		END:      { center: X, bold: 0, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: X, visual: 'end' },
		FRAME:    { center: 0, bold: 0, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: 0, visual: 'frame' },
		HIDDEN:   { center: X, bold: 0, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: X, visual: 'hidden' },
		INPUT:    { center: X, bold: 0, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: 0, visual: 'input' },
		INSTANCE: { center: X, bold: 0, underline: X, italic: 0, dashed: 0, borderless: 0, empty: 0, visual: 'class' },
		LABEL:    { center: 0, bold: 0, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: 0, visual: 'none' },
		NOTE:     { center: 0, bold: 0, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: 0, visual: 'note' },
		PACKAGE:  { center: 0, bold: 0, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: 0, visual: 'package' },
		RECEIVER: { center: 0, bold: 0, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: 0, visual: 'receiver' },
		REFERENCE:{ center: X, bold: 0, underline: 0, italic: 0, dashed: X, borderless: 0, empty: 0, visual: 'class' },
		SENDER:   { center: 0, bold: 0, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: 0, visual: 'sender' },
		START:    { center: X, bold: 0, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: X, visual: 'start' },
		STATE:    { center: X, bold: 0, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: 0, visual: 'roundrect' },
		USECASE:  { center: X, bold: 0, underline: 0, italic: 0, dashed: 0, borderless: 0, empty: 0, visual: 'ellipse' },
	}
	...
	var visualizers = {
		...
		class : function (node, x, y, padding, config, g) {
			...
			if (!style.borderless)
				g.rect(x, y, node.width, node.height).stroke()
		},
	...
	function renderCompartment(compartment, style, level){
		...
		_.each(compartment.lines, function (text, i){
			text = text.replace(/\\s/g, " ") // FIX IS HERE
	...
	function getConfig(d) {
		...
		_.each(d, function (styleDef, key){
			...
			userStyles[key.substring(1).toUpperCase()] = {
				...
				borderless: _.contains(styleDef, 'borderless'),
